...
-- top 5 products which have the highest percentage of purchases with discounts applied?
...
-- Customers who are repeat buyers (more than 5 previous purchases) are also likely to subscribe.
SELECT subscription_status,
...
-- The revenue contribution of each age group is analyzed.
SELECT 
    age_group,
